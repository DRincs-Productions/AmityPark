...
translate spanish functionlabel_CalledBattle_d97cd968:

    # "You've earned [earnedEXP] experience points!"
    "¡Has ganado [earnedEXP] puntos de experiencia!"
...
translate spanish functionlabel_TrainingBattle_d97cd968:
...
translate spanish functionlabel_TrainingMachineBroke_40607a69:
    ...
    simulatorAi "¡Atención! El nivel de la \"Batería Fenton\" ha alcanzado un nivel crítico. \nNo se pueden iniciar más simulaciones. \nPor favor, espere hasta que la batería Fenton se haya recargado."

translate spanish strings:

    # game/code/battleoverhaul/renpy/9999-battle-label.rpy:123
    old "Turn on Super Danny for battle and retry."
    new "Activa a Super Danny para la batalla y vuelve a intentarlo."
