...
translate french talk_to_Lily_nasty_burger_01_f9318bf6:

    # lily "Hi there, welcome to Nasty Burger, may I take your order?"
    lily "Bonjour, bienvenue à Nasty Burger, puis-je prendre votre commande ?"

# game/code/locations/Nasty_Burger_Interaction_MZ.rpy:25
translate french Nesty_Op1_c45965d8:

    # danny talk_happy sad_2 "Are you taking anybody on for quick shifts at all? Just looking to make a few bucks today."
    danny talk_happy sad_2 "Est-ce que vous prenez quelqu'un pour des gardes rapides ? Je cherche juste à me faire un peu d'argent aujourd'hui."

# game/code/locations/Nasty_Burger_Interaction_MZ.rpy:29
translate french Nesty_Op1_2eb27fc7:

    # lily "Yeup, all the time. I'll get you a spare uniform and you can get to work!"
    lily "Oui, tout le temps. Je vais te trouver un uniforme de rechange et tu pourras te mettre au travail !"

# game/code/locations/Nasty_Burger_Interaction_MZ.rpy:38
translate french Nesty_Op1_839a2d54:

    # lily "Well that'd be nice, but shouldn't you be heading to school at your age right now?"
    lily "Ce serait bien, mais ne devrais-tu pas aller à l'école à ton âge maintenant ?"

# game/code/locations/Nasty_Burger_Interaction_MZ.rpy:40
translate french Nesty_Op1_e370138c:

    # lily "Try coming back later in the day when we're open and classes are over"
    lily "Essayez de revenir plus tard dans la journée lorsque nous sommes ouverts et que les cours sont terminés"

# game/code/locations/Nasty_Burger_Interaction_MZ.rpy:48
translate french Nesty_Op1_21d8684b:

    # danny sad talk_happy_2 "Oh no thank you, I'm good. See you around."
    danny sad talk_happy_2 "Oh non merci, c'est bon. A plus tard."

translate french strings:

    # game/code/locations/Nasty_Burger_Interaction_MZ.rpy:21
    old "What do I want at Nasty Burger?"
    new "Qu'est-ce que je veux chez Nasty Burger ?"

    # game/code/locations/Nasty_Burger_Interaction_MZ.rpy:21
    old "Work for a portion of the day."
    new "Travaillez pendant une partie de la journée."
